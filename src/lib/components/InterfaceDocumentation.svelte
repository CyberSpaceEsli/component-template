<div class="mt-5">
   <div class="flex space-x-2 lg:items-center">
      ...
      <h1 class="text-indigo-600 font-bold text-2xl">UI-Component-Template | Documentation </h1>
   </div>
   <p class="mt-2 text-gray-900 text-sm">Alert: Be familiar with the best practices and the structured process of Atomic Design before your read this documentation.</p>

   <div class="mt-5 py-5 px-9 border">
      <div class="mt-2 flex space-x-2 lg:items-center">
      ...
      <!-- Alert component -->
      <div class="mt-2 rounded-md bg-gray-50 p-5">
         <div class="flex">
      ...
      <div class="mt-10 flex space-x-2 lg:items-center">
         <svg class="w-6 h-6 text-gray-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
      ...
      <div class="ml-3">
         <div class="mt-2 text-gray-900 py-2 px-5">
            <ul role="list" class="list-disc space-y-1 pl-5">
               ...
               <li>Provides a modern and manageable frontend to show the visual side of your components</li>
               <li>Faster component tracking with the implemented search tool in the frontend</li>
            </ul>
         </div>
      </div>
      ...
      <div class="mt-2 p-2 px-5 text-gray-900">
